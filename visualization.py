...
def create_scatter_plot(df, param1, param2):
    ...
    # Get parameter information
    param1_info = get_parameter_info(param1)
    param2_info = get_parameter_info(param2)
...
def create_map_visualization(df, parameter):
    ...
    # Scale point sizes based on values
    ...
    # Create layers
    layers = [
        # Base scatter plot layer only (removed text layer with location names)
        pdk.Layer(
            "ScatterplotLayer",
            data=df,
